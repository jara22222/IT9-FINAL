 ...
 <script src="https://unpkg.com/htmx.org@1.9.2"></script>
  ...
  <body>
            ...
            <div class="menu mt-3 border-bottom " style="padding-bottom: 6.5rem;">
              <ul class="list-unstyled">
                ...
                <li class="links"><a href="{{route('admin')}}" class="form-control " hx-boost="true" hx-push-url="true">
                  ...
                  <li class="links"><a href="{{route('admin.suppliers')}}" class="form-control active"  hx-boost="true" hx-push-url="true">
    ...
    <div class="d-flex justify-content-between align-items-center">
        <p class="display-6" style="font-weight: 600">Add suppliers</p>
        <button class="btn h-50 text-white" style="background: #1b85b8" data-bs-toggle="modal" data-bs-target="#productmodal">
            Add supplier
        </button>
    </div>
    ...
    <div class="modal fade" id="productmodal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form hx-post="/add-suppliers" hx-target="body" hx-swap="innerHTML">
                    @csrf
                    <div class="modal-header d-flex justify-content-between">
                        <h5 class="modal-title" id="modalLabel">Add Supplier</h5>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <span class="text-dark">Company Branch</span>
                            <div class="col-md-12 my-3">
